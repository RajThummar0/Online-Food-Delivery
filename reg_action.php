...
include 'connection/conne//ct.php';
    ...
    if ($countem == 1) { // If email exists
        ...
        if (mysqli_query($db, $ins_token)) {
            ...
            try {
                ...
                $mail->Body = 'Congratulations!dear Your account has been created successfully. This email is for your account verification.
                Kindly click on the link below to verify your account. You will be able to login into your account only after account verification.
                <a href="index.php"> Click here to verify your account</a>' ;
                ...
                if ($mail->send()) {
                    ...
                    header("Location: login.php"); // Redirect to pass_otp.php after sending email
                    exit();
                } else {
