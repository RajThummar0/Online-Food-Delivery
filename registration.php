...
if (isset($_POST['btn'])) {
    ...
    $q = "INSERT INTO `registration`(`fullname`, `email`, `mobile`, `password`,`token`) VALUES ('$fn','$em',$mobile,'$pwd,'$token')";
    ...
    if (mysqli_query($db, $q)) {
        ...
        try {
            ...
            // Recipients
            $mail->setFrom('rajthummar2512@gmail.com', 'Janki Kansagra'); // Sender's email address and name
            ...
            <a href="http://localhost:90/janki%20mem/food/verify_account.php?em=' . $em . '&token=' . $token . '">Click here to verify your account</a>';
