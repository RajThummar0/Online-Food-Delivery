        ...
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link active " href="admin/login.php" ><img src="" class="sr-only" /></a>
                                <a href="admin/login.php"><i class="fa fa-power-off" width="18%"></i>admin </a>
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
							...
							?>
                                        <tr>
                                            ...
                                            <a href="edit_profile.php?user_upd='.$rows['u_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
